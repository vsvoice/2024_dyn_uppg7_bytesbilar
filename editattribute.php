...
<div class="container mt-5">
    ...
    <form action="" method="post">
        ...
        <a href='listattributes.php?option=<?php echo $currentOption ?>' class='btn btn-warning me-1'>Avbryt</a>
        <input class="btn btn-primary me-1" type="submit" name="edit-attribute" value="Skicka"> 
    </form>
</div>
