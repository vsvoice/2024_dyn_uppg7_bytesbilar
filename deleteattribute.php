...
<div class="container mt-5">
    ...
    <form action="" method="post">
        ...
        <input class="btn btn-warning me-1" type="submit" name="cancel-delete" value="Avbryt">
        <input class="btn btn-danger" type="submit" name="delete-attribute" value="Ta bort">
    </form>
</div>
