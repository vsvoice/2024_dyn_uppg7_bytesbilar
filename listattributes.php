        ...
        <label for="new-attribute" class="form-label"> Välj ett alternativ att redigera/ta bort:</label><br>
            <ul class="list-group">
                ...
                foreach($attributeData as $attribute) {
                    ...
                    {$attribute[$keys[1]]}<br> 
                    <a href='deleteattribute.php?option={$currentOption}&attribute={$tableRow}' class='btn btn-danger mt-2 me-1'>Ta bort</a>
                    <a href='editattribute.php?option={$currentOption}&attribute={$tableRow}' class='btn btn-warning mt-2'>Redigera</a>
                    </li>";
                    $tableRow++;
                }
                ?>
